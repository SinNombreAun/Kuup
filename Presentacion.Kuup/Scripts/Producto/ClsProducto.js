    ...
    let Producto = (function () {
        let _Nucleo = function () {
            ...
            let _Inicio = function () {
                ...
                if (Funcionalidad == "DETALLE") {
                    ...
                    if (AplicarPrecioDeMayoreo == "SI") {
                        $("#" + Elementos_Producto.TablaMayoreo)
                            .parent()
                            .parent()
                            .parent()
                            .parent()
                                    ...
                                    for (var i = 0; i < data.data.length; i++) {
                                        TablaM.row
                                            .add({
                                                ...
                                                PrecioDeMayoreo: parseFloat(
                                                    data.data[i].PrecioDeMayoreo
                                                ).toFixed(2),
                                            })
                                            .draw();
                                    }
            ...
            function GeneraGridDeMayoreo() {
                ...
                RemoveProducto(
                    "#" + Elementos_Producto.TablaMayoreo + " tbody",
                    TablaM
                );
            }
            ...
            function GeneraGridDeProducto() {
                $("#" + Elementos_Producto.Tabla + " thead tr")
                    .clone(true)
                    .appendTo("#" + Elementos_Producto.Tabla + " thead");
                $("#" + Elementos_Producto.Tabla + " thead tr:eq(1) th").each(function (
                    i
                ) {
                    debugger;
                    if (this.id != "boton") {
                        if (Elementos_Producto.SelectTablas.indexOf(this.id) > -1) {
                            var Elemento =
                                CombosParaTabla[
                                Elementos_Producto.SelectTablas.indexOf(this.id)
                                ];
                            $(this).html(Elemento);
                        } else {
                            var title = $(this).text();
                ...
                var table = $("#" + Elementos_Producto.Tabla).DataTable({
                    ...
                    columns: [
                        ...
                        {
                            defaultContent:
                                "<button type='button' class='detalle btn btn-info'>Detalle</button>",
                        },
                    ],
                    language: LenguajeEN(),
                });
            ...
            var DetalleRegistro = function (tbody, table) {
                $(tbody).on("click", "button.detalle", function () {
                    ...
                    window.location.href =
                        UrlDetalle + "?NumeroDeProducto=" + data.NumeroDeProducto;
                });
            };
            ...
            function OcultaCampos() {
                switch (Funcionalidad) {
                    case "ALTA":
                        $("#" + Elementos_Producto.CveCorreoSurtido)
                            .parent()
                            .hide();
                        $("#" + Elementos_Producto.CantidadMinima)
                            .parent()
                            .hide();
                        $("#" + Elementos_Producto.NumeroDeProveedor)
                            .parent()
                            .hide();
                        break;
                    case "EDITA":
                ...
                switch (Funcionalidad) {
                    ...
                    case "DETALLE":
                        ...
                        $("#" + Elementos_Producto.AgregarPrecioM).click(function () {
                            CreaDialog(
                                Elementos_Producto.AgregaPrecioMayoreo,
                                "Registra Precio de Mayoreo",
                                CreaBotonesDialog(),
                                400,
                                420
                            );
                                        ...
                                        try {
                                            response(
                                                $.map(data, function (item) {
                                                    return {
                                                        label: item.NombreDeProducto,
                                                        value: item.NombreDeProducto,
                                                    };
                                                })
                                            );
                                        } catch (e) {
            ...
            function CargaPrecios() {
                $.ajax({
                    ...
                    async: false,
                    data: {
                        NombreOCodigoDeProducto: $(
                            "#" + Elementos_Producto.CodigoONombreDeProducto
                        ).val(),
                    },
                    success: function (data) {
                        if (data.Precios.length != 0) {
                            ...
                            for (var i = 0; i <= data.Precios.length - 1; i++) {
                                ...
                                let label =
                                    ...
                                    data.Precios[i].id +
                                    '">' +
                                    data.Precios[i].Campo +
                                    "</label>";
                                let textp = "";
                                if (typeof data.Precios[i].CampoHijo != "undefined") {
                                    textp =
                                        data.Precios[i].CampoHijo +
                                        " con precio de " +
                                        data.Precios[i].ValorHijo;
                                }
                                if (typeof data.Precios[i].CampoPadre != "undefined") {
                                    textp =
                                        data.Precios[i].CampoPadre +
                                        " con precio de " +
                                        data.Precios[i].ValorPadre;
                                }
                                let texbox =
                                    '<input class="form-control" data-val="true" id="' +
                                    data.Precios[i].id +
                                    '" name="' +
                                    data.Precios[i].id +
                                    '" type="text" value="' +
                                    data.Precios[i].Valor +
                                    '">';
                                let botton = "";
                                if (i == data.Precios.length - 1) {
                                    botton =
                                        '<br><button type="button" id="GuardarPrecios" class="btn btn-primary">Guardar</button>';
                                }
                            ...
                            $("#" + Elementos_Producto.GuardarPrecios).click(function () {
                                    ...
                                    for (var i = 0; i <= Ids.length - 1; i++) {
                                        switch (Ids[i].Tipo) {
                                            ...
                                            case "Precio Paquete Padre":
                                                PPadre +=
                                                    "NumeroDeProductoPadre=" +
                                                    Ids[i].Id.split("_")[0] +
                                                    "&NumeroDeProductoHijo=" +
                                                    Ids[i].Id.split("_")[1] +
                                                    "&PrecioDeProductoPadre=" +
                                                    $("#" + Ids[i].Id).val() +
                                                    ":";
                                                break;
                                ...
                                $.ajax({
                                    ...
                                    data: {
                                        Precios:
                                            Unitario.substring(0, Unitario.length - 1) +
                                            ":" +
                                            Mayoreo.substring(0, Mayoreo.length - 1) +
                                            ":" +
                                            PPadre.substring(0, PPadre.length - 1) +
                                            ":" +
                                            PHijo.substring(0, PHijo.length - 1),
                                    },
                                    success: function (data) {
                    ...
                    error: function () {
                        alertify.error(
                            "Ocurrio un error al realizar la validacion del Producto"
                        );
                    },
                });
            }
                        ...
                        click: function () {
                            ...
                            if ($("#" + Elementos_Producto.CantidadMinimaM).val() != "") {
                                if (!isNaN($("#" + Elementos_Producto.CantidadMinimaM).val())) {
                                    ...
                                    alertify.error(
                                        "El campo Cantidad Minima debe ser de tipo numerico"
                                    );
                                    Continua = false;
                                }
                            } else {
                            ...
                            if (Continua) {
                                if ($("#" + Elementos_Producto.CantidadMaxima).val() != "") {
                                    if (
                                        ...
                                        alertify.error(
                                            "El campo Cantidad Maxima debe ser de tipo numerico"
                                        );
                                        Continua = false;
                                    }
                                } else {
                            ...
                            if (Continua) {
                                if ($("#" + Elementos_Producto.CantidadMaxima).val() != 0) {
                                    if (
                                        ...
                                        alertify.error(
                                            "El campo Cantidad Minima no debe ser mayor al campo Cantidad Maxima"
                                        );
                                        Continua = false;
                                    }
                                }
                                    ...
                                    if ($("#" + Elementos_Producto.PrecioDeMayoreo).val() != 0) {
                                        ...
                                        TablaM.row
                                            .add({
                                                ...
                                                CantidadMinima: $(
                                                    "#" + Elementos_Producto.CantidadMinimaM
                                                ).val(),
                                                CantidadMaxima: $(
                                                    "#" + Elementos_Producto.CantidadMaxima
                                                ).val(),
                                                PrecioDeMayoreo: parseFloat(
                                        ...
                                        $("#" + Elementos_Producto.AgregaPrecioMayoreo).dialog(
                                            "close"
                                        );
                                        LimpiaMayoreo();
                                        $("#" + Elementos_Producto.GuardaPrecioM).show();
                                        ...
                                        alertify.error(
                                            "El campo Precio de Mayoreo debe ser mayor a 0"
                                        );
                                    }
                                } else {
            ...
            $("#" + Elementos_Producto.Guardar).click(function () {
                if (
                    $("#" + Elementos_Producto.CodigoDeBarras).val() == "" &&
                    $("#" + Elementos_Producto.NombreDeProducto).val()
                ) {
                    alertify
                        .confirm(
                            "Codigo de Barras",
                            "Este producto no cuenta con Codigo de Barras, ¿Desas que el sistema genere un Codigo de Barras para este producto?",
                            function () {
                            ...
                            function () {
                                ...
                                $("form").submit();
                                alertify.warning(
                                    "Proceso de Alta sin generación de Código de Barras"
                                );
                            }
                        )
                        .set("labels", {
                            ok: "Si, Generar Codigo",
                            cancel: "No, Generar Codigo",
                        });
                } else {
                    $("#" + Elementos_Producto.GeneraCodigoDeBarras).val(1);
                    $("form").submit();
        ...
        let _Constructor = function (ObjetoConfiguracion) {
            ...
            NucleoConfigurado.Configuracion.Funcionalidad(
                ObjetoConfiguracion.Funcionalidad
            );
            NucleoConfigurado.Configuracion.NumeroDeProductoModel(
                ObjetoConfiguracion.NumeroDeProductoModel
            );
            NucleoConfigurado.Configuracion.CodigoDeBarrasModel(
                ObjetoConfiguracion.CodigoDeBarrasModel
            );
            NucleoConfigurado.Configuracion.AplicarPrecioDeMayoreo(
                ObjetoConfiguracion.AplicarPrecioDeMayoreo
            );
            NucleoConfigurado.Configuracion.UrlAutoCompleteProducto(
                ObjetoConfiguracion.UrlAutoCompleteProducto
            );
            NucleoConfigurado.Configuracion.UrlCargaGrid(
                ObjetoConfiguracion.UrlCargaGrid
            );
            NucleoConfigurado.Configuracion.UrlDetalle(
                ObjetoConfiguracion.UrlDetalle
            );
            NucleoConfigurado.Configuracion.UrlCargaMasiva(
                ObjetoConfiguracion.UrlCargaMasiva
            );
            NucleoConfigurado.Configuracion.UrlDescargaDeArchivo(
                ObjetoConfiguracion.UrlDescargaDeArchivo
            );
            NucleoConfigurado.Configuracion.UrlGuardaTablaMayoreo(
                ObjetoConfiguracion.UrlGuardaTablaMayoreo
            );
            NucleoConfigurado.Configuracion.UrlCargaMayoreo(
                ObjetoConfiguracion.UrlCargaMayoreo
            );
            NucleoConfigurado.Configuracion.UrlCargaPrecios(
                ObjetoConfiguracion.UrlCargaPrecios
            );
            NucleoConfigurado.Configuracion.UrlPreciosActualizados(
                ObjetoConfiguracion.UrlPreciosActualizados
            );
            NucleoConfigurado.Configuracion.CombosParaTabla(
                ObjetoConfiguracion.CombosParaTabla
            );

...
namespace Mod.Entity
{
    ...
    public partial class DBKuupEntities : DbContext
    {
        ...
        public virtual ObjectResult<ProductosVendidosPeriodo_Result> ProductosVendidosPeriodo(Nullable<System.DateTime> fechaInicio, Nullable<System.DateTime> fechaFin)
        {
            var fechaInicioParameter = fechaInicio.HasValue ?
                new ObjectParameter("fechaInicio", fechaInicio) :
                new ObjectParameter("fechaInicio", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ProductosVendidosPeriodo_Result>("ProductosVendidosPeriodo", fechaInicioParameter, fechaFinParameter);
        }
    }
}
